#!/usr/bin/env python3
"""Generate all JSON data files for Beste 52-scenario framework"""
import json, os

BASE = "/opt/beste-arkclaw"
...
with open(os.path.join(CASES, "boundary", "boundary_cases.json"), "w", encoding="utf-8") as f:
    json.dump({"cases": boundary, "total": len(boundary), "type": "boundary"}, f, ensure_ascii=False, indent=2)
print(f"Boundary cases: {len(boundary)}")
...
exception = [
    ...
    {"id": "CS-E001", "scene": "客服", "name": "知识库无匹配", "input": {"query": "一个非常特殊的问题", "customer_type": "technical"}, "mock_scenario": "no_match", "expected": {"error": False, "fallback": "转人工"}, "type": "exception"},
    ...
    {"id": "PM-E001", "scene": "项目管理", "name": "并发更新冲突", "input": {"task": "update_progress", "